...
namespace MongoDB.Entities.Utilities
{
    ...
    {
        public static IEnumerable<TDocument> Current<TDocument>(this IAsyncCursor<TDocument> cursor, IClientSessionHandle session) where TDocument : IEntity
        {
        ...
        public static TDocument First<TDocument>(
          ...
          CancellationToken cancellationToken = default(CancellationToken)) where TDocument : IEntity
        {
            using (cursor)
            {
